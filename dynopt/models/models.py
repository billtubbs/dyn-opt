...
class Model:
    ...
    means to generate and fit different models to different 
    combinations of data inputs and outputs by using Pandas 
    dataframes which have named columns to identify each data
    series.
